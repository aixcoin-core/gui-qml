  ...
  if test "$aixcoin_cv_static_qt" = "yes"; then
    ...
    if test "$use_qml" != "no"; then
      if test "$TARGET_OS" != "android"; then
        ...
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQmlPlugin], [-lqmlplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQmlModelsPlugin], [-lmodelsplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuick2Plugin], [-lqtquick2plugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuick2WindowPlugin], [-lwindowplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuickLayoutsPlugin], [-lqquicklayoutsplugin])
        dnl qtquickcontrols module plugins
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuickControls1Plugin], [-lqtquickcontrolsplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuick2DialogsPlugin], [-ldialogplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuick2DialogsPrivatePlugin], [-ldialogsprivateplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QmlFolderListModelPlugin], [-lqmlfolderlistmodelplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QmlSettingsPlugin], [-lqmlsettingsplugin])
        dnl qtquickcontrols2 module plugins
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuickControls2Plugin], [-lqtquickcontrols2plugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuickTemplates2Plugin], [-lqtquicktemplates2plugin])
      else
        dnl qtdeclarative module plugins
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQmlPlugin], [-lqml_QtQml_qmlplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQmlModelsPlugin], [-lqml_QtQml_Models_2_modelsplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuick2Plugin], [-lqml_QtQuick_2_qtquick2plugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuick2WindowPlugin], [-lqml_QtQuick_Window_2_windowplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuickLayoutsPlugin], [-lqml_QtQuick_Layouts_qquicklayoutsplugin])
        dnl qtquickcontrols module plugins
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuickControls1Plugin], [-lqml_QtQuick_Controls_qtquickcontrolsplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuick2DialogsPlugin], [-lqml_QtQuick_Dialogs_dialogplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuick2DialogsPrivatePlugin], [-lqml_QtQuick_Dialogs_Private_dialogsprivateplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QmlFolderListModelPlugin], [-lqml_Qt_labs_folderlistmodel_qmlfolderlistmodelplugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QmlSettingsPlugin], [-lqml_Qt_labs_settings_qmlsettingsplugin])
        dnl qtquickcontrols2 module plugins
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuickControls2Plugin], [-lqml_QtQuick_Controls_2_qtquickcontrols2plugin])
        _AIXCOIN_QT_CHECK_STATIC_PLUGIN([QtQuickTemplates2Plugin], [-lqml_QtQuick_Templates_2_qtquicktemplates2plugin])
      fi
    fi
  fi
  ...
  if test "$use_qml" != "no"; then
    AIXCOIN_QT_CHECK([
      PKG_CHECK_MODULES([QT_QML], [${qt_lib_prefix}Qml${qt_lib_suffix} $qt_version], [QT_INCLUDES="$QT_QML_CFLAGS $QT_INCLUDES" QT_LIBS="$QT_QML_LIBS $QT_LIBS"],
                        [AIXCOIN_QT_FAIL([${qt_lib_prefix}Qml${qt_lib_suffix} $qt_version not found])])
    ])
    AIXCOIN_QT_CHECK([
      PKG_CHECK_MODULES([QT_QML_MODELS], [${qt_lib_prefix}QmlModels${qt_lib_suffix} $qt_version], [QT_INCLUDES="$QT_QML_MODELS_CFLAGS $QT_INCLUDES" QT_LIBS="$QT_QML_MODELS_LIBS $QT_LIBS"],
                        [AIXCOIN_QT_FAIL([${qt_lib_prefix}QmlModels${qt_lib_suffix} $qt_version not found])])
    ])
    AIXCOIN_QT_CHECK([
      PKG_CHECK_MODULES([QT_QUICK], [${qt_lib_prefix}Quick${qt_lib_suffix} $qt_version], [QT_INCLUDES="$QT_QUICK_CFLAGS $QT_INCLUDES" QT_LIBS="$QT_QUICK_LIBS $QT_LIBS"],
                        [AIXCOIN_QT_FAIL([${qt_lib_prefix}Quick${qt_lib_suffix} $qt_version not found])])
    ])
    AIXCOIN_QT_CHECK([
      PKG_CHECK_MODULES([QT_QUICKCONTROLS], [${qt_lib_prefix}QuickControls2${qt_lib_suffix} $qt_version], [QT_INCLUDES="$QT_QUICKCONTROLS_CFLAGS $QT_INCLUDES" QT_LIBS="$QT_QUICKCONTROLS_LIBS $QT_LIBS"],
                        [AIXCOIN_QT_FAIL([${qt_lib_prefix}QuickControls2${qt_lib_suffix} $qt_version not found])])
    ])
