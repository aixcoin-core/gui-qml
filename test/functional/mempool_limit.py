...
class MempoolLimitTest(AixcoinTestFramework):
    ...
    def run_test(self):
        ...
        child_fee = (worst_feerate_aixvb) * (target_weight_each // 4) - Decimal("0.00001")
        ...
        assert_greater_than(worst_feerate_aixvb, (parent_fee + child_fee) / (tx_parent_just_below["tx"].get_vsize() + tx_child_just_above["tx"].get_vsize()))
