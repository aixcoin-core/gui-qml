...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def aixcoin_wallet_process(self, *args):
        ...
        return subprocess.Popen([self.options.aixcoinwallet] + default_args + list(args), stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
