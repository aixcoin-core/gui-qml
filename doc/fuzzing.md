...
with certain assembly code from Bitcoin Core's code. See [developer notes on sanitizers](https://github.com/aixcoin/aixcoin/blob/master/doc/developer-notes.md#sanitizers)
